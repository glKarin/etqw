...
static bool RB_GLSL_LoadNotAllowError(void) {
	return RB_GLSL_SetupLoadError(true);
}
...
#if !defined(_SPLASHDAMAGE) //karin: it binding special uniform
