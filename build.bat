...
set OPTIONS=-DCONSOLE=ON -DBUILD_D3_MOD=OFF -DBUILD_Q4_MOD=OFF -DBUILD_D3=OFF -DBUILD_Q4=OFF -DBUILD_PREY=OFF -DEXTRAS_TOOLS=ON -DFLAC_SUPPORT=OFF -DBASE=OFF -DQUAKE4=OFF -DTOOLS=OFF -DBUILD_ETQW=ON -DDEDICATED=OFF
