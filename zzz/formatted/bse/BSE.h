...
public:
    ...
    {
        on ? mFlags |= flag : mFlags &= ~flag;
    }

    bool					GetExpired( void ) const
    {
        return( ( bool )( mFlags & SFLAG_EXPIRED ) );
    }
    bool					GetSoundPlaying( void ) const
    {
        return( !!( mFlags & SFLAG_SOUNDPLAYING ) );
    }
    bool					GetHasMotionTrail( void ) const
    {
        return( !!( mFlags & SFLAG_HASMOTIONTRAIL ) );
    }

    void					SetExpired( bool expired )
    {
        SetFlag( expired, SFLAG_EXPIRED );
    }
    void					SetSoundPlaying( bool soundPlaying )
    {
        SetFlag( soundPlaying, SFLAG_SOUNDPLAYING );
    }
    void					SetHasMotionTrail( bool hmt )
    {
        SetFlag( hmt, SFLAG_HASMOTIONTRAIL );
    }

    int						GetMotionTrailCount( void )
    {
        return( mActiveCount );
    }

    rvSegmentTemplate		*GetSegmentTemplate( void );
    const		rvDeclEffect			*GetEffectDecl( void )
    {
        return( mEffectDecl );
    }
    ...
    soundChannel_t			GetSoundChannel( void )
    {
        return static_cast< soundChannel_t >( mSegmentTemplateHandle ) + SCHANNEL_ONE;
    }
...
public:
    ...
    rvSegmentTemplate( const rvSegmentTemplate& copy )
    {
        *this = copy;
    }

    void					operator = ( const rvSegmentTemplate &copy );
    bool					operator == ( const rvSegmentTemplate& a ) const
    {
        return Compare ( a );
    }
    bool					operator != ( const rvSegmentTemplate& a ) const
    ...
    {
        return( !!( mFlags & STFLAG_ENABLED ) );
    }
    bool					GetLocked( void ) const
    {
        return( !!( mFlags & STFLAG_LOCKED ) );
    }
    bool					GetHasParticles( void ) const
    {
        return( !!( mFlags & STFLAG_HASPARTICLES ) );
    }
    bool					GetHasPhysics( void ) const
    {
        return( !!( mFlags & STFLAG_HASPHYSICS ) );
    }
    bool					GetIgnoreDuration( void ) const
    {
        return( !!( mFlags & STFLAG_IGNORE_DURATION ) );
    }
    bool					GetInfiniteDuration( void ) const
    {
        return( !!( mFlags & STFLAG_INFINITE_DURATION ) );
    }
    bool					GetAttenuateEmitter( void ) const
    {
        return( !!( mFlags & STFLAG_ATTENUATE_EMITTER ) );
    }
    bool					GetInverseAttenuate( void ) const
    {
        return( !!( mFlags & STFLAG_INVERSE_ATTENUATE ) );
    }
    bool					GetUseMaterialColor( void ) const
    {
        return( !!( mFlags & STFLAG_USEMATCOLOR ) );
    }
    bool					GetTemporary( void ) const
    {
        return( !!( mFlags & STFLAG_TEMPORARY ) );
    }
    bool					GetDepthSort( void ) const
    {
        return( !!( mFlags & STFLAG_DEPTH_SORT ) );
    }
    bool					GetInverseDrawOrder( void ) const
    {
        return( !!( mFlags & STFLAG_INVERSE_DRAWORDER ) );
    }
    bool					GetOrientateIdentity( void ) const
    {
        return( !!( mFlags & STFLAG_ORIENTATE_IDENTITY ) );
    }
    bool					GetComplexParticle( void ) const
    {
        return( !!( mFlags & STFLAG_COMPLEX ) );
    }
    bool					GetCalculateDuration( void ) const
    {
        return( !!( mFlags & STFLAG_CALCULATE_DURATION ) );
    }

    void					SetEnabled( bool enabled )
    {
        SetFlag( enabled, STFLAG_ENABLED );
    }
    void					SetLocked( bool locked )
    {
        SetFlag( locked, STFLAG_LOCKED );
    }
    void					SetHasParticles( bool hasParticles )
    {
        SetFlag( hasParticles, STFLAG_HASPARTICLES );
    }
    void					SetHasPhysics( bool hasPhysics )
    {
        SetFlag( hasPhysics, STFLAG_HASPHYSICS );
    }
    void					SetIgnoreDuration( bool ignoreDuration )
    {
        SetFlag( ignoreDuration, STFLAG_IGNORE_DURATION );
    }
    void					SetInfiniteDuration( bool infiniteDuration )
    {
        SetFlag( infiniteDuration, STFLAG_INFINITE_DURATION );
    }
    void					SetAttenuateEmitter( bool attenuate )
    {
        SetFlag( attenuate, STFLAG_ATTENUATE_EMITTER );
    }
    void					SetInverseAttenuate( bool attenuate )
    {
        SetFlag( attenuate, STFLAG_INVERSE_ATTENUATE );
    }
    void					SetUseMaterialColor( bool attenuate )
    {
        SetFlag( attenuate, STFLAG_USEMATCOLOR );
    }
    void					SetTemporary( bool persistent )
    {
        SetFlag( persistent, STFLAG_TEMPORARY );
    }
    void					SetDepthSort( bool locked )
    {
        SetFlag( locked, STFLAG_DEPTH_SORT );
    }
    void					SetInverseDrawOrder( bool inverseDrawOrder )
    {
        SetFlag( inverseDrawOrder, STFLAG_INVERSE_DRAWORDER );
    }
    void					SetOrientateIdentity( bool orientateIdentity )
    {
        SetFlag( orientateIdentity, STFLAG_ORIENTATE_IDENTITY );
    }
    void					SetComplexParticle( bool enabled )
    {
        SetFlag( enabled, STFLAG_COMPLEX );
    }
    void					SetCalculateDuration( bool calculateDuration )
    {
        SetFlag( calculateDuration, STFLAG_CALCULATE_DURATION );
    }

    const idStr				&GetSegmentName( void ) const
    {
        return( mSegmentName );
    }
    ...
    int						GetTrailSegmentIndex( void ) const
    {
    ...
    {
        return( rvRandom::flrand( mLocalStartTime[0], mLocalStartTime[1] ) );
    }
    float					GetDuration( void ) const
    {
        return( rvRandom::flrand( mLocalDuration[0], mLocalDuration[1] ) );
    }
    ...
    {
        return( rvRandom::flrand( mSoundVolume[0], mSoundVolume[1] ) );
    }
    float					GetFreqShift( void ) const
    {
        return( rvRandom::flrand( mFreqShift[0], mFreqShift[1] ) );
    }
    float					GetDensity( void ) const
    {
        return( rvRandom::flrand( mDensity[0], mDensity[1] ) );
    }
    float					GetMaxDensity( void ) const
    {
        return( mDensity[1] );
    }
    float					GetParticleCap( void ) const
    {
        return( mParticleCap );
    }
    float					GetMaxCount( void ) const
    {
        return( mCount[1] );
    }
    ...
    rvParticleTemplate		*GetParticleTemplate( void )
    {
        return( &mParticleTemplate );
    }
    const rvParticleTemplate*GetParticleTemplate( void ) const
    {
        return( &mParticleTemplate );
    }
...
public:
    ...
    rvDeclEffect( const rvDeclEffect& copy )
    {
        Init();
        *this = copy;
    }
    ...
    bool					operator== ( const rvDeclEffect& comp ) const
    {
        return Compare ( comp );
    }
    bool					operator!= ( const rvDeclEffect& comp ) const
    ...
    bool					GetEditorModified( void ) const
    {
        return( !!( mFlags & ETFLAG_EDITOR_MODIFIED ) );
    }
    bool					GetHasSound( void ) const
    {
        return( !!( mFlags & ETFLAG_HAS_SOUND ) );
    }
    bool					GetHasPhysics( void ) const
    {
        return( !!( mFlags & ETFLAG_HAS_PHYSICS ) );
    }
    bool					GetUsesEndOrigin( void ) const
    {
        return( !!( mFlags & ETFLAG_USES_ENDORIGIN ) );
    }
    bool					GetAttenuates( void ) const
    {
        return( !!( mFlags & ETFLAG_ATTENUATES ) );
    }
    bool					GetOrientateIdentity( void ) const
    {
        return( !!( mFlags & ETFLAG_ORIENTATE_IDENTITY ) );
    }
    bool					GetUsesAmbientCubeMap( void ) const
    {
        return( !!( mFlags & ETFLAG_USES_AMBIENT_CUBEMAP ) );
    }

    void					SetEditorModified( bool modified )
    {
        base->EnsureNotPurged ( );
        SetFlag( modified, ETFLAG_EDITOR_MODIFIED );
    }
    void					SetHasSound( bool hasSound )
    {
        SetFlag( hasSound, ETFLAG_HAS_SOUND );
    }
    void					SetHasPhysics( bool hasPhysics )
    {
        SetFlag( hasPhysics, ETFLAG_HAS_PHYSICS );
    }
    void					SetUsesEndOrigin( bool usesEndOrigin )
    {
        SetFlag( usesEndOrigin, ETFLAG_USES_ENDORIGIN );
    }
    void					SetAttenuates( bool attenuates )
    {
        SetFlag( attenuates, ETFLAG_ATTENUATES );
    }
    void					SetOrientateIdentity( bool orientateIdentity )
    {
        SetFlag( orientateIdentity, ETFLAG_ORIENTATE_IDENTITY );
    }
    void					SetUsesAmbientCubeMap( bool usesAmbientCubeMap )
    {
        SetFlag( usesAmbientCubeMap, ETFLAG_USES_AMBIENT_CUBEMAP );
    }

    rvSegmentTemplate		*GetSegmentTemplate( int i )
    {
        return( &mSegmentTemplates[i] );
    }
    const rvSegmentTemplate	*GetSegmentTemplate( int i ) const
    {
        return( &mSegmentTemplates[i] );
    }
    ...
    float					GetMinDuration( void ) const
    {
        return( mMinDuration );
    }
    void					SetMaxDuration( float duration );
    float					GetMaxDuration( void ) const
    {
        return( mMaxDuration );
    }
    ...
    int						GetNumSegmentTemplates( void ) const
    {
        return( mSegmentTemplates.Num() );
    }
    ...
    void					IncPlayCount( void ) const
    {
        mPlayCount++;
    }
    int						GetPlayCount( void ) const
    {
        return( mPlayCount );
    }
    void					IncLoopCount( void ) const
    {
        mLoopCount++;
    }
...
public:
    ...
    {
        return( !!( mFlags & EFLAG_LOOPING ) );
    }
    bool					GetHasEndOrigin( void ) const
    {
        return( !!( mFlags & EFLAG_HASENDORIGIN ) );
    }
    bool					GetEndOriginChanged( void ) const
    {
        return( !!( mFlags & EFLAG_ENDORIGINCHANGED ) );
    }
    bool					GetStopped( void ) const
    {
        return( !!( mFlags & EFLAG_STOPPED ) );
    }
    bool					GetOrientateIdentity( void ) const
    {
        return( !!( mFlags & EFLAG_ORIENTATE_IDENTITY ) );
    }

    void					SetLooping( bool looping )
    {
        SetFlag( looping, EFLAG_LOOPING );
    }
    void					SetHasEndOrigin( bool hasEndOrigin )
    {
        SetFlag( hasEndOrigin, EFLAG_HASENDORIGIN );
    }
    void					SetEndOriginChanged( bool endOriginChanged )
    {
        SetFlag( endOriginChanged, EFLAG_ENDORIGINCHANGED );
    }
    virtual void			SetStopped( bool stopped )
    {
        SetFlag( stopped, EFLAG_STOPPED );
    }
    virtual void			SetOrientateIdentity( bool orientateIdentity )
    {
        SetFlag( orientateIdentity, EFLAG_ORIENTATE_IDENTITY );
    }
    ...
    {
        return( time > mStartTime + mDuration );
    }
    ...
    int						GetSuppressLightsInViewID( void ) const
    {
        return mSuppressLightsInViewID;
    }
    ...
    {
        return( mCurrentTime - mLastTime > BSE_TIME_EPSILON );
    }
    ...
    rvSegment				*GetTrailSegment( int child )
    {
        return( &mSegments[child] );
    }
    rvSegment				*GetTrailSegment( const idStr &name );

    const idVec3			&GetViewOrg( void ) const
    {
        return( mViewOrg );
    }
    const idMat3			&GetViewAxis( void ) const
    {
        return( mViewAxis );
    }
    ...
    const idVec3			&GetGravityDir( void ) const
    {
        return( mGravityDir );
    }

    const idVec3			&GetOriginalOrigin( void ) const
    {
        return( mOriginalOrigin );
    }
    const idVec3			&GetOriginalEndOrigin( void ) const
    {
        return( mOriginalEndOrigin );
    }
    const idMat3			&GetOriginalAxis( void ) const
    {
        return( mOriginalAxis );
    }
    const idMat3			&GetLightningAxis( void ) const
    {
        return( mLightningAxis );
    }

    const idVec3			&GetCurrentOrigin( void ) const
    {
        return( mCurrentOrigin );
    }
    const idVec3			&GetCurrentVelocity( void ) const
    {
        return( mCurrentVelocity );
    }
    const idVec3			&GetCurrentEndOrigin( void ) const
    {
        return( mCurrentEndOrigin );
    }
    const idVec3			GetInterpolatedOffset( float time ) const;
    const idMat3			&GetCurrentAxis( void ) const
    {
        return( mCurrentAxis );
    }
    const idMat3			&GetCurrentAxisTransposed( void ) const
    {
        return( mCurrentAxisTransposed );
    }
    virtual const idBounds		&GetCurrentLocalBounds( void ) const
    {
        return( mCurrentLocalBounds );
    }
    const idBounds			&GetLastRenderBounds( void ) const
    {
        return( mLastRenderBounds );
    }
    const idVec3			&GetCurrentWindVector( void ) const
    {
        return( mCurrentWindVector );
    }

    void					UpdateSegments( float time );
    virtual int				GetValidFrames( void ) const
    {
        return mValidFrames;
    };
    ...
    const idVec3&			GetMaterialColor() const
    {
