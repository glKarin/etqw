...
public:
    ...
    {
        return sizeof( sdDeclAmbientCubeMap );
    }
    ...
    // Getters and setters
    const idList< ambientLight_t >&	GetAmbientLights() const
    {
    ...
    idVec3							GetAmbientColor() const
    {
        return ambientColor;
    }
    idVec3							GetHighLightColor() const
    {
        return highLightColor;
    }
    idVec4							GetAvgAmbientColor() const
    {
        return avgAmbientColor;
    }
    ...
    idVec3							GetMinSpecAmbientColor() const
    {
        return minSpecAmbientColor;
    }
    idVec3							GetMinSpecShadowColor() const
    {
        return minSpecShadowColor;
    }
    void							SetMinSpecAmbientColor( const idVec3 &color )
    {
        minSpecAmbientColor = color;
    }
    ...
    idImage*						GetAmbientCubeMap() const
    {
        return const_cast< idImage* >( ambientCubeMap );
    }
    idImage*						GetLightCubeMap() const
    {
        return const_cast< idImage* >( lightCubeMap );
    }
    idImage*						GetSpecularCubeMap() const
    {
        return const_cast< idImage* >( specularCubeMap );
    }
    idImage*						GetEnvironmentCubeMap() const
    {
        return const_cast< idImage* >( environmentCubeMap );
    }
    idImage*						GetGradientMap() const
    {
        return const_cast< idImage* >( gradientMap );
    }

    void							SetSunParameters( const idVec3& sunDirection, const idVec3& sunColor );

    // Needed for editor
    int								AddAmbientLight( const ambientLight_t& ambientLight )
    {
        return ambientLights.Append( ambientLight );
    }
    void							UpdateAmbientLight( int index, const ambientLight_t& value )
    {
        ambientLights[index] = value;
    }
    void							RemoveAmbientLight( int index )
    {
        ambientLights.RemoveIndex( index );
    }
    ...
    void							SetAmbientColor( const idVec3 &color )
    {
        ambientColor = color;
    }
    void							SetHighLightColor( const idVec3 &color )
    {
