...
public:
    ...
    bool						IsKeyEvent( void ) const
    {
        return type == SE_KEY;
    }
    bool						IsCharEvent( void ) const
    {
        return type == SE_CHAR;
    }
    bool						IsRealMouseEvent( void ) const
    {
        return type == SE_MOUSE;
    }
    bool						IsMouseEvent( void ) const
    {
        return type == SE_MOUSE || type == SE_CONTROLLER_MOUSE;
    }
    bool						IsControllerMouseEvent( void ) const
    {
        return type == SE_CONTROLLER_MOUSE;
    }
    bool						IsMouseButtonEvent( void ) const
    {
        return type == SE_MOUSE_BUTTON;
    }
    bool						IsConsoleEvent( void ) const
    {
        return type == SE_CONSOLE;
    }
    bool						IsControllerButtonEvent( void ) const
    {
        return type == SE_CONTROLLER_BUTTON;
    }
    bool						IsGuiEvent( void ) const
    {
        return type == SE_GUI;
    }
    bool						IsIMEEvent( void ) const
    {
        return type == SE_IME;
    }
    ...
    {
        return static_cast< float >( value2 );
    }
    ...
    unsigned int				GetScanCode( void ) const
    {
        return static_cast< unsigned int >( value );
    }
    keyNum_e					GetKey( void ) const
    {
        return static_cast< keyNum_e >( value );
    }
#else
    unsigned int				GetScanCode( void ) const
    {
    ...
    keyNum_e					GetKey( void ) const
    {
        return static_cast< keyNum_e >( ( value & 0xFF00 ) >> 8 );
    }
#endif
    ...
    bool						IsKeyRepeat( void ) const
    {
        return ( value2 & 0x2 ) != 0;
    }

    mouseButton_t				GetMouseButton() const
    {
        return static_cast< mouseButton_t >( value );
    }

    int							GetGuiAction( void ) const
    {
        return value;
    }

    bool						IsButtonDown( void ) const
    {
        return ( value2 & 0x1 ) != 0;
    }
    int							GetControllerHash( void ) const
    {
        return value2 >> 1;
    }
    ...
    // SE_IME
    imeEvent_t					GetIMEEvent() const
    {
        return static_cast< imeEvent_t >( value );
    }
    const wchar_t*				GetCompositionString() const
    {
        return reinterpret_cast< const wchar_t* >( ptr );
    }

    idLinkList< sdSysEvent >&	GetNode( void )
    {
        return node;
    }
...
public:
    ...
    virtual sdControllerManager&	GetControllerManager()
    {
