...
// run-time conversion from degrees to radians and vice versa
...
public:
    ...
    static int					FloorPowerOfTwo( int x );	// round x down to the first power of 2, returns x if x is a power of two
    static int					CeilPowerOfTwo( int x );	// round x up to the first power of 2, returns x if x is a power of two
