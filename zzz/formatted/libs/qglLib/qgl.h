...
// debian sarge GL header having incomplete prototypes define for that one?
...
void			GLimp_AssignQGLPointers();
void			GLimp_AssignPortableExtensionQGLPointers();
...
#ifdef MACOS_X
extern PFNGLSECONDARYCOLOR3BEXTPROC			qglSecondaryColor3b;
#else
...
#if defined( __APPLE__ ) || defined( ID_GL_HARDLINK ) || defined( _XBOX )
