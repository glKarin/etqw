...
void __thiscall rvBSE::UpdateFromOwner(rvBSE *this, renderEffect_s *parms, float time, bool init)
{
  ...
  *(float *)&v45[7] = z;
  ...
  v33 = 0;
  this->mCurrentLocalBounds.b[1].z = -idMath::INFINITY;
  this->mCurrentLocalBounds.b[1].y = -idMath::INFINITY;
  this->mCurrentLocalBounds.b[1].x = -idMath::INFINITY;
  do
  {
        ...
        idBounds *bounds)
{
  ...
  if ( bse_showBounds.internalVar->integerValue )
  {
    ...
    *(float *)&v38[11] = v25;
    ...
    globalBounds.b[1].z = -idMath::INFINITY;
