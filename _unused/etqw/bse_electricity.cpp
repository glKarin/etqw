        ...
        float endFraction)
{
  ...
  while ( count >= 1 )
  {
    ...
    v67 = forward_4 * left - left_4 * v13; // a.y * ? - ? * a.x |z
    down = left_4 * forward_8 - forward_4 * 0.0; // ? * a.z - a.y * 0 |x
    down_4 = v13 * 0.0 - forward_8 * left; // a.x * 0 - a.z * ? |y
    v18 = 1.0 - shapea;
    v51 = end.y * v18;
    v52 = end.z * v18;
    v65 = start.y * shapea;
        ...
        idVec3 end)
{
  ...
  *(_QWORD *)&old.y = *(_QWORD *)&start.y;
  eval = 1;
  count = 0;
  v42 = left_4 * work->forward.z - work->forward.y * 0.0; // a.z * ? - a.y * 0 | x
  offset_8 = 0.0;
  offset_4 = 0.0;
  offset = 0.0;
  coords = work->coords;
  // (z=0), left = x, left_4 = y
  v43 = work->forward.x * 0.0 - left * work->forward.z; // a.x * 0 - a.z * ? | y
  v44 = left * work->forward.y - left_4 * work->forward.x; // a.y * ? - a.x * ? | z
  x = start.x;
  old.x = start.x;
  while ( 1 )
  {
