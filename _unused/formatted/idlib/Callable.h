...
public:
    ...
    sdBinderMember0( Func func_, T* obj_ ) : obj( obj_ )
    {
        function = func_;
    }
    ...
    RetType operator()( T1 arg1)
    {
        return ((*obj).*function)( arg1 );
    }
    RetType operator()( T1 arg1, T2 arg2 )
    {
        return ((*obj).*function)( arg1, arg2 );
    }
    RetType operator()( T1 arg1, T2 arg2, T3 arg3 )
    {
...
ID_INLINE sdBinderMember0< RetType, T, Func, T1, T2, T3 > sdBindMem0( Func func, T* obj )
{
    return sdBinderMember0< RetType, T, Func, T1, T2, T3 >( func, obj );
}
...
public:
    ...
    sdBinderMember1( Func func_, T* obj_, T1 arg1_ ) : arg1( arg1_ ), obj( obj_ )
    {
        function = func_;
    }
    ...
    RetType operator()( T2 arg2 )
    {
        return ((*obj).*function)( arg1, arg2 );
    }
    RetType operator()( T2 arg2, T3 arg3 )
    {
        return ((*obj).*function)( arg1, arg2, arg3 );
    }
...
*/
template< class RetType, class T1, class T2, class T3, class T, class Func >
ID_INLINE sdBinderMember1< RetType, T, Func, T1, T2, T3 > sdBindMem1( Func func, T* obj, T1 arg1 )
{
    return sdBinderMember1< RetType, T, Func, T1, T2, T3 >( func, obj, arg1 );
}
...
public:
    ...
    mutable Func function;
    virtual Ret operator()( T1 arg1 ) const
    {
...
public:
    ...
    mutable Func function;
    virtual Ret operator()( T1 arg1, T2 arg2 ) const
    {
...
public:
    ...
    mutable Func function;
    virtual Ret operator()( T1 arg1, T2 arg2, T3 arg3 ) const
    {
...
template< class T >
ID_INLINE sdReferenceWrapper< T > sdRef( T& t )
{
    return sdReferenceWrapper< T >( t );
}

template< class T >
ID_INLINE sdReferenceWrapper< T const > const sdCRef( T const & t )
{
    return sdReferenceWrapper< T const >( t );
}
