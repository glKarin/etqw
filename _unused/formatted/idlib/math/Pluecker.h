...
{
// FIXME: make sure to compile with -fno-unsafe-math-optimizations instead
#if 0
// #ifdef MACOS_X //DAJ BUGFIX the round off the gcc does
    double v0, v1, v2, v3, v4, v5;
    v0 = (double)(start[0]) * (double)(end[1]);
    v1 = (double)(end[0])   * (double)(start[1]);
    v2 = (double)(start[0]) * (double)(end[2]);
    v3 = (double)(end[0])   * (double)(start[2]);
    v4 = (double)(start[1]) * (double)(end[2]);
    v5 = (double)(end[1])   * (double)(start[2]);
    p[0] = v0 - v1;
    p[1] = v2 - v3;
    p[2] = start[0] - end[0];
    p[3] = v4 - v5;
...
// #ifdef MACOS_X //DAJ BUGFIX the round off the gcc does
    double v0, v1, v2, v3, v4, v5;
    v0 = (double)(start[0]) * (double)(dir[1]);
    v1 = (double)(dir[0])   * (double)(start[1]);
    v2 = (double)(start[0]) * (double)(dir[2]);
    v3 = (double)(dir[0])   * (double)(start[2]);
    v4 = (double)(start[1]) * (double)(dir[2]);
    v5 = (double)(dir[1])   * (double)(start[2]);
    p[0] = v0 - v1;
    p[1] = v2 - v3;
    p[2] = -dir[0];
    p[3] = v4 - v5;
...
{
#if 0
// #ifdef MACOS_X //DAJ BUGFIX lousy gcc floating point
    double v0, v1, v2, v3, v4, v5, v6;
    v0 = (double)(p[0]) * (double)(a.p[4]);
    v1 = (double)(p[1]) * (double)(a.p[5]);
    v2 = (double)(p[2]) * (double)(a.p[3]);
    v3 = (double)(p[4]) * (double)(a.p[0]);
    v4 = (double)(p[5]) * (double)(a.p[1]);
    v5 = (double)(p[3]) * (double)(a.p[2]);
