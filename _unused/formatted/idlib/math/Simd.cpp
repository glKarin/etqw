...
void TestCalculateCullBits( void )
{
    ...
    lightPlanes[0][0] =  0.0f;
    lightPlanes[0][1] =  0.0f;
    lightPlanes[0][2] =  1.0f;
    lightPlanes[0][3] = -5.0f;
    lightPlanes[1][0] =  0.0f;
    lightPlanes[1][1] =  0.0f;
    lightPlanes[1][2] = -1.0f;
    lightPlanes[1][3] =  5.0f;
    lightPlanes[2][0] =  0.0f;
    lightPlanes[2][1] =  1.0f;
    lightPlanes[2][2] =  0.0f;
    lightPlanes[2][3] = -5.0f;
    lightPlanes[3][0] =  0.0f;
    lightPlanes[3][1] = -1.0f;
    lightPlanes[3][2] =  0.0f;
    lightPlanes[3][3] =  5.0f;
    lightPlanes[4][0] =  1.0f;
    lightPlanes[4][1] =  0.0f;
    lightPlanes[4][2] =  0.0f;
    lightPlanes[4][3] = -5.0f;
    lightPlanes[5][0] = -1.0f;
    lightPlanes[5][1] =  0.0f;
    lightPlanes[5][2] =  0.0f;
    lightPlanes[5][3] =  5.0f;
