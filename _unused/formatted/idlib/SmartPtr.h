...
public:
    ...
    template< class U >
    bool friend		operator==( const Pointer lhs, const sdSmartPtr< U >& rhs )
    {
        return lhs == rhs.pointee;
    }

    template< class U >
    bool friend		operator==( const sdSmartPtr< U >& lhs, const Pointer rhs )
    {
        return lhs.pointee == rhs;
    }

    template< class U >
    bool friend		operator==( const sdSmartPtr< U >& lhs, const sdSmartPtr& rhs )
    {
        return lhs.Get() == rhs.pointee;
    }
    ...
    template< class U >
    bool friend		operator!=( const sdSmartPtr& lhs, const sdSmartPtr< U >& rhs )
    {
...
public:
    ...
    sdSmartPtr< T >&			GetThisPtr()
    {
        return thisPtr;
    }
    const sdSmartPtr< T >&		GetThisPtr() const
    {
        return thisPtr;
    }

    sdSmartPtrFromThis&			operator=( const sdSmartPtrFromThis& rhs )
    {
        return *this;
    }
