...
struct sdNetEntityId {
    ...
    bool			operator ==( const sdNetEntityId& rhs ) const
    {
    ...
    {
        id[0] = ( value & 0xFFFFFFFF00000000 ) >> 32;
        id[1] = ( value & 0x00000000FFFFFFFF );
    }
    void			ToUInt64( uint64_t& value ) const
    {
        value = ( ( (uint64_t)id[0] << 32 ) | id[1] );
    }
};
