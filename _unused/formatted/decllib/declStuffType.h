...
public:
    ...
    {
        return models[index].c_str();
    }
    bool					GetRandomizeAngles( void ) const
    {
        return randomizeAngles;
    }
    const sdDeclStuffType * GetLodType( void ) const
    {
        return lodType;
    }
