...
public:
    ...
    void					SetAPITypeIndex( const int index )
    {
        apiTypeIndex = index;
    }
    ...
    controllerState_e		GetState() const
    {
        return state;
    }
    ...
    const float*			GetAxisArray() const
    {
        return axis;
    }

    idKey&					GetButton( int index )
    {
        return idKeyInput::GetKeyByIndex( buttons[ index ] );
    }
...
public:
    ...
    controllerApiState_e	GetState() const
    {
        return state;
    }
...
public:
    ...
    int												GetMaxControllers() const
    {
        return controllers.Num();    // maximum amount of supported controllers
    }
    ...
    sdController&									GetController( const int index )
    {
