...
#ifdef _MSC_VER
#ifdef _ETQW
#define ID_BEGIN_DBG_QUIET() _putenv(ID_DEBUG_ENV "=1")
#define ID_END_DBG_QUIET() _putenv(ID_DEBUG_ENV "=")
#else
#define ID_BEGIN_DBG_QUIET() _putenv(ID_DEBUG_ENV "=1")
#define ID_END_DBG_QUIET() _putenv(ID_DEBUG_ENV "=")
#endif
...
#else
#define ID_BEGIN_DBG_QUIET() setenv(ID_DEBUG_ENV, "1", 1)
#define ID_END_DBG_QUIET() unsetenv(ID_DEBUG_ENV)
